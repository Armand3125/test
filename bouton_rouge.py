...
with cols[0]:
    ...
    selected_color_name_1 = st.radio("", color_options, index=0)  # Case à cocher sans texte visible
...
with cols[2]:
    # Liste des options de couleurs avec cases à cocher sans texte
    selected_color_name_2 = st.radio("", color_options, index=1)  # Case à cocher sans texte visible
